...
#valgrind --tool=callgrind --dump-instr=yes build/xnf_cdcl_solver ../benchmarks/instances/2xnfs/matrix_multiplication/MM-22.xnf -ca 1uip -t 60
...
#valgrind --tool=callgrind --dump-instr=yes build/xnf_cdcl_solver ../benchmarks/instances/2xnfs/mq/toyexamples/ToyExample-type1-n20-seed0.xnf -ca 1uip -t 60 -cm
...
#valgrind --tool=callgrind build/xnf_cdcl_solver ../benchmarks/instances/2xnfs/rand/rand-20-60.xnf -dh vsids -ca 1uip -rh no -t 30 -cm
valgrind --tool=callgrind --dump-instr=yes --simulate-cache=yes --collect-jumps=yes build/xnf_cdcl_solver ../benchmarks/generate_instances/bivium/bivium-t354-g55.2xnf -ca 1uip -po save -ip nbu -rh luby -dh vsids
#valgrind --tool=callgrind --dump-instr=yes build/xnf_cdcl_solver ../benchmarks/generate_instances/bivium/bivium-t354-g55.2xnf -ca 1uip -po save -ip nbu -rh luby -dh vsids

kcachegrind callgrind.out.*
rm callgrind.out.*

#valgrind --tool=cachegrind build/xnf_cdcl_solver ../benchmarks/instances/2xnfs/rand/rand-20-60.xnf -dh lex -ca 1uip -rh luby -t 30
#
